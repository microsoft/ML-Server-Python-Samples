# Operationalization samples for Microsoft Machine Learning Server (Python)
...
|Integrate a real-time web service into an application|[Notebook](Publish_Realtime_Web_Service_in_Python.ipynb)|[Documentation](https://docs.microsoft.com/en-us/machine-learning-server/operationalize/python/quickstart-application-integration-with-swagger)|
